    ...
    return Scaffold(
      ...
      body: MaterialApp(
        ...
        home: ChangeNotifierProvider(
          ...
          child: const ImageColors(
            //title: 'Image Colors',
            image: AssetImage('assets/a.jpg'),
            //image: Image.asset(image.path),
            imageSize: Size(256.0, 250.0),
          ),
        ),
      ),
...
class PaletteSwatch extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //final palette = context.read<PaletteModel>();
      ...
      child: color == null
          ...
          : Container(
              ...
              /*child: GridView.count(
                ...
                crossAxisCount: 2,
                crossAxisSpacing: 1.0, // 縦
                mainAxisSpacing: 1.0, // 横
